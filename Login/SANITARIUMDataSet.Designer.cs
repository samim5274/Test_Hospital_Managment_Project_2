...
namespace Login {
    ...
    public partial class SANITARIUMDataSet : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserInfoRow AddUserInfoRow(string FastName, string LastName) {
            ...
            private void InitClass() {
                ...
                this.columnFastName.MaxLength = 50;
        ...
        public partial class UserInfoRow : global::System.Data.DataRow {
            ...
            public string FastName {
                get {
                    try {
                        return ((string)(this[this.tableUserInfo.FastNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'FastName\' in table \'UserInfo\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableUserInfo.FastNameColumn] = value;
                }
            }
            ...
            public bool IsFastNameNull() {
                return this.IsNull(this.tableUserInfo.FastNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetFastNameNull() {
                this[this.tableUserInfo.FastNameColumn] = global::System.Convert.DBNull;
            }
...
namespace Login.SANITARIUMDataSetTableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserInfo] ([FastName], [LastName]) VALUES (@FastName, @LastNam" +
                "e)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@FastName", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "FastName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT FastName, LastName FROM dbo.UserInfo";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT FastName, LastName\r\nFROM     UserInfo";
        ...
        public virtual int Fill(SANITARIUMDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual SANITARIUMDataSet.UserInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SANITARIUMDataSet.UserInfoDataTable dataTable = new SANITARIUMDataSet.UserInfoDataTable();
        ...
        public virtual int FillBy(SANITARIUMDataSet.UserInfoDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SANITARIUMDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual int Insert(string FastName, string LastName) {
            if ((FastName == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(FastName));
            }
            if ((LastName == null)) {
